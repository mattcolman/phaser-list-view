...
Scroller.prototype = Object.create({
  ...
  requestDiff: function requestDiff(diff, target, min, max, overflow) {
    var scale = 0;
    if (target > max) {
  ...
  addMomentum: function addMomentum(o) {
